...
class RetrieveIdentificationUseCaseTest{


    private lateinit var retrieveIdentificationUseCase: RetrieveIdentificationUseCase
    ...
    fun setUp(){
        ...
        retrieveIdentificationUseCase = RetrieveIdentificationUseCase(fakeMushroomIdentificationRepositoryImpl)
    }

    @Test
    fun `Retrieve Mushroom Identification test`() = runTest{
        ...
        val actualResult = retrieveIdentificationUseCase("acs1").dropWhile { it is Resource.Loading }.first()
